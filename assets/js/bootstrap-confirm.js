...
!function( $ ){
	...
	$.fn.confirm.defaults = {
		...
		template : '<div class="modal hide fade confirm-modal"><div class="modal-header"><h3></h3></div><div class="modal-body"></div><div class="modal-footer"><a href="javascript:void(0);" class="btn btn-danger confirm-btn">确定</a><a href="javascript:void(0);" class="btn confirm-cancelbtn">取消</a></div></div>'
	}
